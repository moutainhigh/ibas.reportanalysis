...
namespace reportanalysis {
    export namespace bo {
        /** 报表 */
        export class Report extends ibas.BOSimple<Report> implements IReport {
            /** 业务对象编码 */
            ...
            get activated(): ibas.emYesNo {
                return this.getProperty<ibas.emYesNo>(Report.PROPERTY_ACTIVATED_NAME);
            }
            /** 设置-激活 */
        ...
        /** 报表参数 */
        export class ReportParameter extends ibas.BOSimpleLine<ReportParameter> implements IReportParameter {
            ...
            protected onPropertyChanged(name: string): void {
                if (ibas.strings.equalsIgnoreCase(name, ReportParameter.PROPERTY_NAME_NAME)) {
        ...
        /** 报表参数 集合 */
        export class ReportParameters extends ibas.BusinessObjects<ReportParameter, Report> implements IReportParameters {
