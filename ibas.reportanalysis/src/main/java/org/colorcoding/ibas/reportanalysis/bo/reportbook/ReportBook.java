...
public class ReportBook extends BusinessObject<ReportBook> implements IReportBook, IDataOwnership {
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 2822803923282798516L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = ReportBook.class;
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "ReportBook";
	 ...
	 * 属性名称-报表簿-项目
	 */
	private static final String PROPERTY_REPORTBOOKITEMS_NAME = "ReportBookItems";

	/**
	 * 报表簿-项目的集合属性
	 * 
	 */
	public static final IPropertyInfo<IReportBookItems> PROPERTY_REPORTBOOKITEMS = registerProperty(
			PROPERTY_REPORTBOOKITEMS_NAME, IReportBookItems.class, MY_CLASS);
	 ...
	 * @return 值
	 */
	@XmlElementWrapper(name = PROPERTY_REPORTBOOKITEMS_NAME)
	@XmlElement(name = ReportBookItem.BUSINESS_OBJECT_NAME, type = ReportBookItem.class)
	public final IReportBookItems getReportBookItems() {
		return this.getProperty(PROPERTY_REPORTBOOKITEMS);
	}
