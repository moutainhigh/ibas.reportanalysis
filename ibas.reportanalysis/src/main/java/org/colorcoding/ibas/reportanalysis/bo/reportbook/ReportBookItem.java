...
public class ReportBookItem extends BusinessObject<ReportBookItem> implements IReportBookItem {
	 ...
	 * 序列化版本标记
	 */
	private static final long serialVersionUID = 2516614421731472847L;

	/**
	 * 当前类型
	 */
	private static final Class<?> MY_CLASS = ReportBookItem.class;
	 ...
	 * 业务对象名称
	 */
	public static final String BUSINESS_OBJECT_NAME = "ReportBookItem";
	 ...
	 * 报表编号 属性
	 */
	@DbField(name = "Report", type = DbFieldType.NUMERIC, table = DB_TABLE_NAME, primaryKey = false)
